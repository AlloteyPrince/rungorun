...
<template>
  <nav class="fixed top-0 w-full z-[150] glass py-4 md:py-6">
    <div
      class="container mx-auto px-5 sm:px-6 max-w-6xl flex justify-between items-center"
    >
      <!-- Logo -->
      <NuxtLink
        to="/"
        class="text-xl md:text-2xl font-black italic tracking-tighter uppercase font-['Poppins'] text-white"
      >
      ...
      <!-- Desktop Links -->
      <div
        class="hidden md:flex items-center gap-10 font-black text-xs tracking-[0.2em] uppercase italic"
      >
        <button
      ...
      <div class="flex items-center gap-4">
        ...
        >
          <div
            class="w-2 h-2 bg-rungreen rounded-full animate-pulse shadow-[0_0_10px_#dfff00]"
          ></div>
          <span
            class="text-[10px] font-black tracking-[0.2em] text-rungreen uppercase italic"
            >Live</span
          >
        </div>
        <button
